<div class="bg-white border-2">
    <div class="mx-auto px-4 sm:px-6">
        ...
        <div id="mobileMenu" class="hidden border-l-2 border-gray-300 fixed left-0 top-0 h-full w-2/4 bg-white">
            <div class="mt-5 px-6">
                <a href="/dj"
                   class="block mb-4 text-right pr-4 text-sm font-medium text-gray-700 hover:bg-gray-100">DJ</a>
                <a href="#"
                   class="block mb-4 text-right pr-4 text-sm font-medium text-gray-700 hover:bg-gray-100">About</a>
